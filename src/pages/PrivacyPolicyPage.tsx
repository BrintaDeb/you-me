  ...
  return (
    <main className="container" style={{ paddingTop: '120px', paddingBottom: '100px', maxWidth: '840px' }} id="main-content">
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '28px', color: 'var(--text-secondary)', lineHeight: 1.8 }}>
        <section>
          <h2 style={{ fontSize: '1.4rem', color: 'var(--text-primary)', marginBottom: '12px' }}>1. Information We Collect</h2>
          <p>
        ...
        <section>
          <h2 style={{ fontSize: '1.4rem', color: 'var(--text-primary)', marginBottom: '12px' }}>2. How We Use Your Information</h2>
          <p>
        ...
        <section>
          <h2 style={{ fontSize: '1.4rem', color: 'var(--text-primary)', marginBottom: '12px' }}>3. Data Storage &amp; Security</h2>
          <p>
        ...
        <section>
          <h2 style={{ fontSize: '1.4rem', color: 'var(--text-primary)', marginBottom: '12px' }}>4. Your Rights &amp; Contact Information</h2>
          <p>
